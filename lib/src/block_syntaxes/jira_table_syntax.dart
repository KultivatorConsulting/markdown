...
/// Parses jira tables.
class JiraTableSyntax extends BlockSyntax {
  @override
  ...
  bool canParse(BlockParser parser) {
    ...
    return parser.matchesNext(jiraTablePattern);
  }
  ...
  Node? parse(BlockParser parser) {
    final alignments = _parseAlignments(parser.current);
